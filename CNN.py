...
pixels, labels = load_training_data("/Users/kalryoma/Downloads/fer2013/fer2013.csv")
...
# builder = tf.saved_model.builder.SavedModelBuilder('/Users/kalryoma/Downloads/my-model')
